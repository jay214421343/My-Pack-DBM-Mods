module.exports = {
	...
	<div>
		...
		<div style="float: left; width: 104.5%; padding-top: 15px;">
			Time<br>
			<input id="value" class="round" type="text" placeholder="Insert Seconds Here (eg: 60 -for 1 min)...">
		</div>
    ...
    action: function(cache) {
        ...
        if (this.Cooldown(msg, value) === 1) {
            ...
            //---------------- change the line below this comment if you need a custom message. tell me if you need to edit from dbm and maybe i will make it
